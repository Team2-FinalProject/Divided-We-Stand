...
function preload() {
  ...
  this.data.list.socket.emit("hai", "hai from game js");
}
...
function create(a) {
  ...
  console.log(this.data.list.socket, "ini socket nya data list -<<<<<");
  ...
  console.log(this.socket, "ini sockettttt");
